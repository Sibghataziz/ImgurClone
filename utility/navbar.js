        ...
        <div class="NavbarContainer-left">
            <a href="">
                <svg width="94" height="34" viewBox="0 0 94 34" class="icon stroke fill" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M6.23549 12.4487C6.23549 9.98884 5.33669 8.80659 3.43046 8.80659C1.48851 8.80659 0.589111 9.98884 0.589111 12.4487V22.5745C0.589111 25.0344 1.48851 26.2484 3.43046 26.2484C5.373 26.2484 6.23549 25.0344 6.23549 22.5745V12.4487Z" fill="#ffffff"></path><path d="M3.51952 0.756104C1.58599 0.756104 0 2.1078 0 3.75626C0 5.43752 1.54695 6.7561 3.51952 6.7561C5.45305 6.7561 7 5.43752 7 3.75626C7 2.1078 5.45305 0.756104 3.51952 0.756104Z" fill="#1BB76E"></path>
                </svg>
            </a>
            <a class="Button upload" href="">
                <img src="https://s.imgur.com/desktop-assets/desktop-assets/icon-new-post.13ab64f9f36ad8f25ae3544b350e2ae1.svg" alt="">
                <span>New post</span>
            </a>
        </div>
        <div class="NavbarContainer-center-div">
            <div class="NavbarContainer-center">
                <input class="searchbar-textInput" type="text" placeholder="Images, #tags, @users oh my!" name="q" id="inputBox">
                <button class="Searchbar-submitInput" type="submit">
                    <img src="https://s.imgur.com/desktop-assets/desktop-assets/icon-search.8d0f9b564a4659d48d8eca38b968a7f2.svg" alt="">
                </button>
            </div>
            <div class="NavbarContainer-center-dropDown" id="searchDropDownBox">
                
            </div>
        </div>
        <div class="NavbarContainer-right">
            <a class="EmeraldButton Button" href="">Go Ad-Free</a>
            <div class="NavbarNotifications">
                <a href="">
                    <img src="https://s.imgur.com/desktop-assets/desktop-assets/gift.577aa9948a2b45b6f16f448db9200a08.svg" alt="">
                </a>
                <a href="">
            ...
            <div class="NavbarUserMenuBlock">
                <div>
                    <span>bkabhi</span>
                    <!-- <span class="UserAvatar NavbarAvatar-navbar NavbarAvatar" style="background-image: url(&quot;https://imgur.com/user/bkabhi/avatar&quot;);"></span> -->
                </div>
            </div>
        </div>
    </nav>
